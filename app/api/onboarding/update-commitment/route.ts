// app/api/onboarding/update-commitment/route.ts
...
export async function POST(request: NextRequest) {
  ...
  try {
    const { userId, commitment } = await request.json();
    ...
    // Update user with commitment level
    // Note: You'll need to add a 'commitmentLevel' field to your User model
